...
(1, 'Chi Mai', 'chimai', '10below!!', 'c_mai3@fanshaweonline.ca', '2018-04-09 00:10:53', 1, NULL, '::1');
...
--
ALTER TABLE `tbl_mov_genre`
  MODIFY `mov_genre_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
